...
const ArgonConnectBridge = require( './ArgonConnectBridge' );

const POLL_INTERVAL = 30000;
class ArgonConnectApp extends Homey.App
{
    async onInit()
    {
        this.bridge = new ArgonConnectBridge();
        ...
        this.updateLog( '************** Argon Connect app has initialised. ***************' );
    }
